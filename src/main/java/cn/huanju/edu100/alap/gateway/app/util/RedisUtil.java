package cn.huanju.edu100.alap.gateway.app.util;
...
public class RedisUtil {
     ...
     * @return
     */
    public boolean lSetMIn(String key, String value) {
        try {
     ...
     * @return
     */
    public String lPop(String key, long index) {
        try {
            String o = redisTemplate.opsForList().leftPop(key, index, TimeUnit.SECONDS);
            return o;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
